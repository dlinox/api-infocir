...
namespace App\Modules\Admin\Dairy\Organization\Plant\Http\Requests\Plant;
...
class PlantRequest extends ApiFormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'capacity_liters.numeric'             => 'La :attribute debe ser numérica.',
            'capacity_liters.min'                 => 'La :attribute debe ser mayor o igual a :min.',

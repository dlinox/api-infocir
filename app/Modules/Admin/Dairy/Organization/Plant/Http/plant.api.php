...
Route::middleware(['auth:api', 'check.session'])->prefix('/plants')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/plant-galleries')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/plants/{plantId}/suppliers')->group(function () {

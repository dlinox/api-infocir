...
namespace App\Modules\Admin\Setting\Http\Requests\Area;

use App\Common\Http\Requests\ApiFormRequest;

class AreaRequest extends ApiFormRequest
{
    public function rules()
    {
        ...
        return [
            'id'          => 'nullable|integer',
            'name'        => 'required|string|max:100|unique:learning_areas,name,' . $id . ',id',

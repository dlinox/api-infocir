...
namespace App\Modules\Admin\Setting\Http\Requests\InstructionDegree;

use App\Common\Http\Requests\ApiFormRequest;

class InstructionDegreeRequest extends ApiFormRequest
{
    public function rules()
    {
        ...
        return [
            'id'        => 'nullable|integer',
            'name'      => 'required|string|max:100|unique:core_instruction_degrees,name,' . $id . ',id',

...
namespace App\Modules\Admin\Setting\Http\Requests\CompanyType;

use App\Common\Http\Requests\ApiFormRequest;

class CompanyTypeRequest extends ApiFormRequest
{
    public function rules()
    {
        ...
        return [
            'id'        => 'nullable|integer',
            'name'      => 'required|string|max:100|unique:dairy_company_types,name,' . $id . ',id',

...
Route::middleware(['auth:api', 'check.session'])->prefix('/instruction-degrees')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/professions')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/company-types')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/training-levels')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/positions')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/institution-types')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/product-types')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/unit-measures')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/supplies')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/training-types')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/investment-categories')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/asset-catalog')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/pre-operative-catalog')->group(function () {
...
Route::middleware(['auth:api', 'check.session'])->prefix('/working-capital-catalog')->group(function () {

...
namespace App\Modules\PlantPanel\Worker\Http\Requests;

use App\Common\Http\Requests\ApiFormRequest;

class PlantWorkerRequest extends ApiFormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'monthly_salary.required'          => 'El :attribute es obligatorio.',
            'monthly_salary.numeric'           => 'El :attribute debe ser un número.',
            'monthly_salary.min'               => 'El :attribute no puede ser negativo.',
